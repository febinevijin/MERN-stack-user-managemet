...
function Header(props) {
  ...
  console.log(props.title,'hiiiiiiiiiiiiii');
  console.log(props.Admin,'helooo');
  return (
    <Fragment >
          ...
          <nav className="navbar navbar-expand-lg ">
            <div className="container-fluid">
              <div className="col-lg-3 col-6">
                ...
                {props.Admin ? <a className="navbar-brand" href='/#' onClick={handleClick}>{props.title}</a> : <a className="navbar-brand" href='/#' onClick={handleClick3}>Home</a>}
