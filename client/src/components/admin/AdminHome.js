...
import { Navbar, Table, Container, Button, Form, FormControl } from 'react-bootstrap'
                                ...
                                {arr.map((e) => {
                                    return (
                                        <tr>
                                            ...
                                            <td>{e.phone}</td>
                                            <td>{e.email}</td>
                                            <td><Button className='px-4 buttons1' onClick={() => { editHandle(e._id) }} ><ion-icon name="create-outline"></ion-icon>Edit</Button> 
                                            <Button className='px-3 buttons2' onClick={() => { clickHandler(e._id) }}><ion-icon name="trash-outline"></ion-icon>Delete</Button> </td>
                                        </tr>
                                    )
                                })}
                            </tbody>
